        ...
        if (empty($_POST['user_name'])) {
            ...
            if (!$this->db_connection->connect_errno) {
                ...
                if ($query_check_user_name->num_rows == 1) {
                    ...
                    $query_new_user_insert = $this->db_connection->query("INSERT INTO users (user_name, user_password_hash, user_first_name, user_last_name, user_email) VALUES('" . $this->user_name . "', '" . $this->user_password_hash . "', '" . $this->user_first_name . "', '" . $this->user_last_name . "', '" . $this->user_email . "');");
