    ...
    private function loginWithPostData()
    {
        ...
        if (!empty($_POST['user_name']) && !empty($_POST['user_password'])) {
            ...
            if (!$this->db_connection->connect_errno) {
                ...
                $checklogin = $this->db_connection->query("SELECT user_id, user_name, user_email, user_first_name, user_last_name, user_role, user_password_hash FROM users WHERE user_name = '" . $this->user_name . "';");
                ...
                if ($checklogin->num_rows == 1) {
                    ...
                    if (password_verify($_POST['user_password'], $result_row->user_password_hash)) {
						...
						$_SESSION['full_name'] = $_SESSION['user_first_name'] .' '. $_SESSION['user_last_name'];
